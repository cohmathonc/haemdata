...
## Clear the {pins} cache

From time-to-time, the cache used by the {pins} package  can become corrupted. This is easily fixed by clearing the cache.

From the Terminal in Rstudio, or any shell on your computer, delete one or all corrupted items:
