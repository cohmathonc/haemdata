...
Haemdata provides a simple interface to genomic data for the PSON AML State-transition project at COH, and a complete record of how it was processed from fastq or h5 (10X) to gene expression estimates.
...
See the Articles menu above for more examples.
