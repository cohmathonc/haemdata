...
# Mice 
`Haemdata` includes `r dplyr::n_distinct(metadata_mmu$sample_id, na.rm = TRUE)` samples from `r dplyr::n_distinct(metadata_mmu$mouse_id, na.rm = TRUE)` mice (across `r nrow(metadata_mmu)` sequencing runs). Metadata
