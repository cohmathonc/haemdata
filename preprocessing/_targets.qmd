...
The current implementation of `update_metadata_mmu()` changes `sample_id` prefix to MHO from PSON, simplifies `fastq_1` & `fastq_2` paths, add @yufu1120 sample metadata and adds CML miR-142 KO scRNAseq (LMPP & T cells) metadata.
