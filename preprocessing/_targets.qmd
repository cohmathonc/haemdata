...
list(
    ...
    tar_target(sample_sheet_CML_3,
        ...
        dplyr::select(library_id, fastq_1, fastq_2, strandedness)),
    tar_target(sample_sheet_mrna_mir142ko,
        published_metadata_mmu |>
        dplyr::filter(str_detect(cohort, "^CML.mRNA.mir142ko$")) |>
        dplyr::select(library_id, fastq_1, fastq_2, strandedness))
)        
```
...
tar_target(sample_sheet_mir142ko_10x,
    published_metadata_mmu |>
    dplyr::filter(str_detect(cohort, "^CML.10x.mir142ko$")) |>
