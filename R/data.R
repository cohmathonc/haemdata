...
# cml_mrna_2021_GRCm38_HLT -----------------------------------------------------
#' SummarisedExperiment of 75 samples
#'
...
#'   \item{abundance}{`mat` Salmon *transcript length bias corrected* TPM}
#' }
#' @source \url{http://cgt.coh.org/MHO/CML.mRNA.2021/results/rnaseq3.5.GRCm38.HLT/salmon/salmon.merged.gene_counts_length_scaled.rds}
#' @name cml_mrna_2021_GRCm38_HLT
#' @docType data
#' @keywords cml mrna 2021
#' @usage data(cml_mrna_2021_GRCm38_HLT)
NULL

# cml_mrna_2022_GRCm38_HLT ---------------------------------------------------
